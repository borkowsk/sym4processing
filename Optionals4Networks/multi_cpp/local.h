//Automagically generated file. @date 2024-10-21 19:06:46 
//Dont edit\!
#pragma once
#ifndef LOCAL_H
#define LOCAL_H
...
/*interface*/class iColorable; typedef Processing::ptr<iColorable> piColorable; // { //TODO iColoriser
...
/*interface*/class iFloatRangesWithValueContainer; typedef Processing::ptr<iFloatRangesWithValueContainer> piFloatRangesWithValueContainer; // extends iResetable {
/*interface*/class iFloatValue; typedef Processing::ptr<iFloatValue> piFloatValue; // {
/*interface*/class iFloatValues2IndexedContainer; typedef Processing::ptr<iFloatValues2IndexedContainer> piFloatValues2IndexedContainer; // extends iResetable {
/*interface*/class iFloatValuesIndexedContainer; typedef Processing::ptr<iFloatValuesIndexedContainer> piFloatValuesIndexedContainer; // extends iResetable {
...
/*interface*/class iResetable; typedef Processing::ptr<iResetable> piResetable; // {
...
static 	const int	MASKBITS=0xffffffff; // -> Redefine, when smaller width is required.
static 	const pAllLinks allLinks=new AllLinks();  // -> Such type of filter is used very frequently.

//All global variables from Processing files
extern	float 		BALDHEAD_MUN_ANGLE;	// ->  Baldhead draving GLOBAL parameter.
extern	float 		BALDHEAD_NOSE_DIVIDER;	// ->  Baldhead draving GLOBAL parameter.
extern	float 		BALDHEAD_NOSE_RADIUS;	// ->  Baldhead nose-lenght as ratio of maximal R
extern	float 		BALDHEAD_EARS_DIVIDER;	// ->  Baldhead draving GLOBAL parameter.
...
extern	color 		BALDHEAD_EYES_COLOR;	// ->  Baldhead draving GLOBAL parameter.
extern	float 		BALDHEAD_PUPIL_DIV;	// ->  Baldhead draving GLOBAL parameter.
...
extern	psettings_bar3d 		bar3dsett;	// ->  Default settings of bar3d
extern	float 		XSPREAD;	// ->  how far is target point of link of type 1, from center of the cell
extern	int   		linkCounter;	// ->  number od=f links visualised last time

//All global arrays from Processing files
extern	sarray<pVisual2DNodeAsList>  AllNodes;   // ->  Nodes have to be visualisable!!!
extern	sarray<ppointxy> bar3dromb ;	// ->  @note Global namespace!
