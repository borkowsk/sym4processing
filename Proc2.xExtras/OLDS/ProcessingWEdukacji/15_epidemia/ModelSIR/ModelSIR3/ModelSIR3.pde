...
float IDens=0.75; //Początkowa gęstość w tablicy - jaka jest gęstość progowa,
...
final float PTransfer=0.33;   //Prawdopodobieństwo zarażenia agenta w pojedynczej interakcji
...
void setup()
{
 assert PDeath + PRecovery < 1 : "Za duże prawdopodobieństwa PDeath + PRecovery";//Asercja 
                                                                   //- sprawdzenie założeń
