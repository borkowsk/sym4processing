...
float ah=0;//Przyśpieszenie/hamowanie - tylko w pionie
...
void draw() //Jest wykonywane w niewidocznej pętli
{
  ...
  //Właściwy model
  vh+=random(-20.0,20.0)*1/FR;//Sterowanie wg. preferencji
  vx+=random(-20.0,20.0)*1/FR;//może być asymetryczne - można zobaczyć do czego to prowadzi
